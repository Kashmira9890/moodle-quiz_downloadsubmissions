 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_ds_last_responses_table extends quiz_attempts_report_table {
     ...
     */
	public function __construct($quiz, $context, $qmsubselect, quiz_downloadsubmissions_options $options,
            \core\dml\sql_join $groupstudentsjoins, \core\dml\sql_join $studentsjoins, $questions, $reporturl) {
        parent::__construct('mod-quiz-report-downloadsubmissions-report', $quiz, $context,
